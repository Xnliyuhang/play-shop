...
public class RedisUtils {
    ...
    public boolean cacheValue(String key, Object value, long time) {
        try {
            ...
            System.out.println("缓存[" + key + "]失败, value[" + value + "] " + e.getMessage());
        }
        return false;
    }
    ...
    public boolean containsKey(String key) {
        try {
            ...
            System.out.println("判断缓存是否存在时失败key[" + key + "]"+" "+"err[" + e.getMessage() + "]");
        }
        return false;
    }
    ...
    public Object getValue(String key) {
        try {
            ...
            System.out.println("获取缓存时失败key[" + key + "]"+" "+"err[" + e.getMessage() + "]");
        }
        return null;
    }
    ...
    public boolean removeValue(String key) {
        try {
            ...
            System.out.println("移除缓存时失败key[" + key + "]"+" "+"err[" + e.getMessage() + "]");
        }
        return false;
    }
    ...
    public boolean removeKeys(String pattern) {
        try {
            ...
            System.out.println("移除key[" + pattern + "]前缀的缓存时失败"+" "+"err[" + e.getMessage() + "]");
        }
        return false;
    }
